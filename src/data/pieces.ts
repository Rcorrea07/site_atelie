...
export const pieces: StackSpreadCard[] = [
  ...
  {
    item: { src: "/img/2.png", alt: "Máquina de costura do ateliê" },
  ...
  {
    item: { src: "/img/necessaire.jpg", alt: "Necessaires matelassadas em azul" },
  ...
  {
    item: { src: "/img/estojo.jpg", alt: "Estojo com estampa de bonecas" },
  ...
  {
    item: { src: "/img/bolsa_1.jpg", alt: "Bolsa em tecido cinza com alça estampada" },
  ...
  // meio-direita — praia
  {
    item: { src: "/img/praia.jpg", alt: "Bolsa de praia em tela amarela" },
  ...
  {
    item: { src: "/img/criativa.jpg", alt: "Mochila estampada com alça personalizada" },
  ...
  {
    item: { src: "/img/6.png", alt: "Etiqueta, adesivo e sacola do ateliê" },
    stackOffset: { x: 8, y: 7 },
    stackRotate: 3,
  ...
  {
    item: { src: "/img/background.jpg", alt: "Mesa do ateliê com linhas, tesoura e tecidos" },
